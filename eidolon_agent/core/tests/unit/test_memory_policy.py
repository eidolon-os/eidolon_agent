...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("我在常州工作", MemoryWriteDispositionKind.SEMANTIC_UPSERT),
        ("我的大学是在北京的北京化工大学读的。", MemoryWriteDispositionKind.SEMANTIC_UPSERT),
        ("我毕业于北京化工大学", MemoryWriteDispositionKind.SEMANTIC_UPSERT),
        ("更正一下，我现在住在杭州，不是上海", MemoryWriteDispositionKind.SEMANTIC_UPSERT),
        ("我现在住在哪里？", MemoryWriteDispositionKind.IGNORE),
        ("我大学在哪读的？", MemoryWriteDispositionKind.IGNORE),
