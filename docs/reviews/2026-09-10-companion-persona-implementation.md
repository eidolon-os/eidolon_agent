...
2026-09-11 补充：已按“自动化优先、最后真机”的要求执行跨服务真实 HTTP、Flutter 页面与客户端、30 轮真实模型、Memory 独立进程、gRPC 和语音场景测试，修复系统代理、短期窗口过小与 TTS 大块文本上限问题。最新范围、证据和剩余软件失败见 [自动化验收记录](./2026-09-11-companion-persona-e2e-acceptance.md)；本文件末尾的“尚未验证”是此前状态。
